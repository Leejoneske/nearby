 ...
 * changes — analytics, adverts, a payment step — this text has to change with
 * it, or it stops being true.
 *
...
export const LEGAL: Record<'privacy' | 'terms', LegalDoc> = {
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Your phone number, because it is how you sign in and how we confirm a business belongs to you.',
          'Anything you type in: your name, the reviews you write, and the details of any business you list.',
          'Your approximate location, but only while the app is open and only if you allow it. We use it to sort places by how close they are. We do not track you in the background.',
        ],
      },
      {
  ...
  terms: {
    ...
    updated: '15 August 2026',
    intro:
      'The rules for using Nearby. Using the app means you agree to them.',
    sections: [
      {
        heading: 'Your account',
        paragraphs: [
          'You need a working phone number to sign in. Keep it to yourself — anything done from your account is treated as done by you.',
      ...
      },
      {
        ...
        paragraphs: [
          'Only claim a business you own or are authorised to manage.',
